# Project Name - *InstagramShotOfHappinessApp*

**InstagramShotOfHappinessApp (or shortly called InstagramSha)** is a photo sharing app similar to Instagram but using Parse as its backend.

## User Stories

- [x] User can view the last 20 posts submitted to InstagramShotOfHappinessApp.
- [x] User can pull to refresh the last 20 posts submitted to InstagramShotOfHappinessApp.
